                  ...
                  скоро свяжемся с вами
                        ...
                        <div className="relative ">
                            ...
                            <form
                                ...
                                <div>
                                    <InputUl name={{...register('company_name', {required: true})}} type={"text"}
                                             placeholder={t('form.company')}/>
                                    {errors.company_name && <span className={'text-xs text-red-600 block mt-3 '}>Требуется название компании</span>}
                                </div>
                                <div>
                                    <InputUl name={{...register('email', {required: true,pattern: {
                                                value: /\S+@\S+\.\S+/,
                                            }})}} type={"text"}
                                             placeholder={t('form.email')}/>
                                    {errors.email && <span className={'text-xs text-red-600 block mt-3 '}>Требуется электронная почта</span>}
                                </div>
                                <div>
                                    <textarea
